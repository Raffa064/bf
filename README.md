...
> [!TIP] 
If no arguments is set, the executable will look for `./main.bf`, and if there is more than one argument, only the last one will be used as path for script file.
